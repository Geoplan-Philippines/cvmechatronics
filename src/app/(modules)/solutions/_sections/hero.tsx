    ...
    <section className="relative min-h-[65vh] flex flex-col justify-end overflow-hidden bg-navy">
      <div className="absolute inset-0">
        <Image
          ...
          alt="Modern property with automated glass entrance and clean architectural lines"
          fill
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-6 pb-20 pt-32 lg:pb-28">
        ...
        <div className="max-w-3xl">
          ...
          >
            Automation Solutions for Modern Properties.
          </motion.h1>
          ...
          >
            Five integrated systems — engineered to work independently or as a unified whole.
            Each one precision-installed, app-connected, and built for Philippine conditions.
          </motion.p>
          ...
          >
            ...
            <Link
              href="/products"
              className="inline-flex items-center justify-center font-body font-medium uppercase tracking-[0.04em] rounded-md transition-all duration-150 text-paper border border-paper/30 hover:border-paper/60 hover:bg-paper/8"
