    ...
    <section className="relative min-h-[52vh] flex flex-col justify-end overflow-hidden bg-navy">
      <div className="absolute inset-0">
        <Image
          ...
          alt="Bright modern interior with automated glass and clean architectural lines"
          fill
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-6 pb-16 pt-32 lg:pb-20">
        ...
        <div className="max-w-3xl">
          ...
          >
            Practical guides, product spotlights, and news from the team automating
            gates, glass, cameras, and lighting across the Philippines.
          </motion.p>
        </div>
      </div>
    </section>
